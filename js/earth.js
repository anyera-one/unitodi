...
Tmaterial.size=.047*d;
Tmaterial.opacity=.75;
...
let globeSize = Math.min(
  ...
  document.querySelector(".globes__right").clientHeight
);
  docheight.style.setProperty('--size', `${globeSize}px`);
};
 
resizeGlobalContainer();
window.addEventListener('resize', resizeGlobalContainer);